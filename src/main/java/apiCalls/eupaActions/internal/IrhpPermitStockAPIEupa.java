...
public class IrhpPermitStockAPIEupa extends EupaBaseAPI {
    ...
    public static AvailableCountriesModel availableCountries() throws HttpException {
        ...
        ApiUrl.build(EnvironmentType.getEnum(Properties.get("env", true)), baseResource.concat("available-countries/?dto=Dvsa%5COlcs%5CTransfer%5CQuery%5CIrhpPermitStock%5CAvailableCountries"));
